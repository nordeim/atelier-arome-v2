...
| **Models** | ⚠️ Partial | 16 of 22 models fully implemented, 6 skeleton files |
...
|-----------|--------|----------|
| **Skeleton Models** | 6 need completion | Review, Wishlist, WishlistItem, CouponUsage, NewsletterSubscriber, InventoryMovement |
| **Model Enhancements** | Minor updates | Existing implemented models may need additional scopes/helpers |
...
> **NOTE (Validated January 9, 2026):** Previous version of this plan claimed "13 models missing" — this was inaccurate. Models like Address, Cart, Order, Payment, Coupon, etc. are ALREADY FULLY IMPLEMENTED with fillable, casts, relationships, and scopes.

---

## 🎯 Phase 2 Objectives

1. **Complete Skeleton Models**: Implement 6 skeleton models (Review, Wishlist, WishlistItem, CouponUsage, NewsletterSubscriber, InventoryMovement)
2. **Enhance Existing Models**: Add any missing scopes, helpers, or relationships to 16 implemented models
...
### **Phase 2.1: Complete Skeleton Models & Enhance Existing** (2 hours - Day 1, Morning)

**Objective:** Complete 6 skeleton models and verify/enhance 16 existing implemented models
...
> **NOTE:** The following 7 models were previously listed as "to create" but are **ALREADY FULLY IMPLEMENTED** with fillable, casts, relationships, and scopes. Only verify they meet requirements.

- ✅ `Address.php` (69 lines) — User addresses with type enum, scopes
- ✅ `Cart.php` (89 lines) — Guest/auth support, coupon, calculated totals
- ✅ `CartItem.php` (48 lines) — Variant relationship, line total accessor
- ✅ `Order.php` (129 lines) — Full implementation with order number generation, statuses
- ✅ `OrderItem.php` (48 lines) — Snapshot pattern, line total accessor
- ✅ `Payment.php` (50 lines) — Stripe integration, scopes
- ✅ `Coupon.php` (83 lines) — Validity checks, usage relationships

---

### ⚠️ SKELETON MODELS (Need Full Implementation)
...
- [ ] All 6 skeleton models completed (Review, Wishlist, WishlistItem, CouponUsage, NewsletterSubscriber, InventoryMovement)
- [ ] All skeleton models have HasUuids trait
- [ ] All skeleton models have fillable attributes defined
- [ ] All skeleton models have proper casts defined
...
- [ ] 7 already-implemented models verified (Address, Cart, CartItem, Order, OrderItem, Payment, Coupon)
...
- [ ] 6 skeleton models completed (Review, Wishlist, WishlistItem, CouponUsage, NewsletterSubscriber, InventoryMovement)
- [ ] 7 implemented models verified (Address, Cart, CartItem, Order, OrderItem, Payment, Coupon)
- [ ] 9 existing models enhanced if needed (User, Product, Category, ProductVariant, ProductImage, Tag, Inventory, Setting, Testimonial)
